...
export default function LandingPage() {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        {
          id: "4",          name: "David Smith",          role: "General Manager",          testimonial: "Highly recommended for any local shop wanting more reach.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3D2Qk1okt1zvqqOBkpMsWoBGPUB/portrait-of-a-creative-agency-client-1777592613540-8bed90b6.png"},
        {
          id: "5",          name: "Elena Ross",          role: "Retail Lead",          testimonial: "They made our transition from offline to digital extremely simple.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3D2Qk1okt1zvqqOBkpMsWoBGPUB/portrait-of-a-happy-retail-business-owne-1777592622776-cffb2ca5.png"},
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",          title: "How long does it take?",          content: "Most sites are completed within 2 weeks after gathering requirements."},
        {
          id: "q2",          title: "Do I need technical skills?",          content: "Absolutely not! We manage everything from start to finish."},
        {
          id: "q3",          title: "What about security?",          content: "We include SSL and advanced security protocols on all sites."},
      ]}
  ...
  <div id="footer" data-section="footer">
      ...
      copyrightText="© 2025 NexaSites.com. All rights reserved."
    />
  </div>
      </ReactLenis>
    </ThemeProvider>
